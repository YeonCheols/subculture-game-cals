...
export function App() {
  ...
  const [query, setQuery] = useState(""); const [gameFilter, setGameFilter] = useState("모든 게임"); const [dateFilter, setDateFilter] = useState(""); const [typeFilter, setTypeFilter] = useState("전체"); const [statusFilter, setStatusFilter] = useState("전체 상태"); const [hideEnded, setHideEnded] = useState(false);
